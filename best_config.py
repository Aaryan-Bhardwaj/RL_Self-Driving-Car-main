...
MAX_SIMULATION_CAR = 30

CONSTANT_PENALTY = -0.01

EMERGENCY_BRAKE_MAX_SPEED_DIFF = 20
EMERGENCY_BRAKE_PENALTY = float(os.environ.get('EMERGENCY_BRAKE_PENALTY', -0.00001))

MISMATCH_ACTION_PENALTY = -0.0000047
SWITCHING_LANE_PENALTY = -0.000001
# SWITCHING_LANE_PENALTY = -0
...
LEARN_START = 10000 #changed from 100000
